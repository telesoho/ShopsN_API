...
class WxPayApi {
    ...
    public static function unifiedOrder($inputObj, $timeOut = 6) {
        ...
        //关联参数
        if ($inputObj->GetTrade_type() == "WxPay" && !$inputObj->IsOpenidSet()) {
    ...
    public static function notify($callback, &$msg) {
        file_put_contents( './Uploads/qqq/qingcai----.txt',"notify--------------" . date( 'Y-m-d H:i:s',time() ) . "----555-\r\n",FILE_APPEND );
        ...
        file_put_contents( './Uploads/qqq/qingcai----.txt',"notify--------------" . date( 'Y-m-d H:i:s',time() ) . "----666-\r\n",FILE_APPEND );
    ...
    public static function replyNotify($xml) {
        file_put_contents( './Uploads/qqq/qingcai----.txt',"replyNotify--------------" . date( 'Y-m-d H:i:s',time() ) . "999-\r\n",FILE_APPEND );
