...
{	
	...
	**/
	...
	/**
	* 设置取值如下：WxPay，NATIVE，APP，详细说明见参数规定
	* @param string $value 
	**/
	...
	/**
	* 获取取值如下：WxPay，NATIVE，APP，详细说明见参数规定的值
	* @return 值
	**/
	...
	/**
	* 判断取值如下：WxPay，NATIVE，APP，详细说明见参数规定是否存在
	* @return true 或 false
	**/
	...
	**/
	...
	/**
	* 设置trade_type=WxPay，此参数必传，用户在商户appid下的唯一标识。下单前需要调用【网页授权获取用户信息】接口获取到用户的Openid。
	* @param string $value 
	**/
	...
	/**
	* 获取trade_type=WxPay，此参数必传，用户在商户appid下的唯一标识。下单前需要调用【网页授权获取用户信息】接口获取到用户的Openid。 的值
	* @return 值
	**/
	...
	/**
	* 判断trade_type=WxPay，此参数必传，用户在商户appid下的唯一标识。下单前需要调用【网页授权获取用户信息】接口获取到用户的Openid。 是否存在
	* @return true 或 false
	**/
